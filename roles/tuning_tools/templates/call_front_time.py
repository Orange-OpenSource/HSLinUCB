...
try:
   print("Response duration expected : " + sys.argv[1] + "ms")
except:
...
while loop:
   ...
   try:
      ...
      url = "http://{{hostvars[groups['master'][0]].ansible_default_ipv4.address}}:{{ingress_gateway_port}}/ResponseTime?time=" + sys.argv[1]
