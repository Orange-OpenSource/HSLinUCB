...
try:
   ...
   print("Usage: " + sys.argv[0] + " CpuConsumption IterationNumber")
...
while loop:
   ...
   try:
      ...
      url = "http://{{hostvars[groups['master'][0]].ansible_default_ipv4.address}}:{{ingress_gateway_port}}/Proxy?path=ConsumeFixedCpu?cpu=" + sys.argv[1]
